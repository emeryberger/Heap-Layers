...
#define PROT_MAX(p) 0
#endif
#define HL_MMAP_PROTECTION_MASK                                                \
...
#endif
    ptr = VirtualAlloc(nullptr, sz, MEM_RESERVE | MEM_COMMIT | MEM_TOP_DOWN,
                       permflags);
    return ptr;
  }

  static void unmap(void *ptr, size_t) { VirtualFree(ptr, 0, MEM_RELEASE); }
