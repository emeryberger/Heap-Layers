...
extern "C" void *MYCDECL HEAP_LAYERS_INLINE CUSTOM_CALLOC(size_t nelem,
                                                          size_t elsize);
...
extern "C" void *MYCDECL CUSTOM_VALLOC(size_t sz) {
  return CUSTOM_MEMALIGN(4096UL,
                         sz); // Default page size on most architectures.
}
...
// fseek, fsetpos
// _fullpath, fwrite, getc, getchar, _getcwd, _getdcwd, gets, _getw, _popen,
// printf, putc
// putchar, _putenv, puts, _putw, scanf, _searchenv, setvbuf, _strdup, system,
// _tempnam,
