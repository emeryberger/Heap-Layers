...
/**
 * @file kingsleyheap.h
 * @brief Classes to implement a Kingsley (power-of-two, segregated fits)
 * allocator.
 */
...
inline size_t class2Size(const int i) { return (size_t)(1 << (i + 3)); }
...
class KingsleyHeap
    : public StrictSegHeap<Kingsley::NUMBINS, Kingsley::size2Class,
                           Kingsley::class2Size, PerClassHeap, BigHeap> {};
}
