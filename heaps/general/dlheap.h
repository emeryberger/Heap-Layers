...
public:
  ...
  inline void free(void *ptr) { super::free(Header::getHeader(ptr)); }
  inline int remove(void *ptr) { return super::remove(Header::getHeader(ptr)); }
};
...
template <int ThresholdBytes, class super> class Threshold : public super {
public:
  enum { MIN_LARGE_SIZE = 64 };

#if 1
  Threshold(void)
      : freeAllNextMalloc(FALSE), inUse(0), maxInUse(0), threshold(0) {}
...
namespace DLBigHeapNS {
const size_t bins[] = {
    8U,        16U,        24U,        32U,        40U,         48U,
    56U,       64U,        72U,        80U,        88U,         96U,
    104U,      112U,       120U,       128U,       136U,        144U,
    152U,      160U,       168U,       176U,       184U,        192U,
    200U,      208U,       216U,       224U,       232U,        240U,
    248U,      256U,       264U,       272U,       280U,        288U,
    296U,      304U,       312U,       320U,       328U,        336U,
    344U,      352U,       360U,       368U,       376U,        384U,
    392U,      400U,       408U,       416U,       424U,        432U,
    440U,      448U,       456U,       464U,       472U,        480U,
    488U,      496U,       504U,       512U,       576U,        640U,
    704U,      768U,       832U,       896U,       960U,        1024U,
    1088U,     1152U,      1216U,      1280U,      1344U,       1408U,
    1472U,     1536U,      1600U,      1664U,      1728U,       1792U,
    1856U,     1920U,      1984U,      2048U,      2112U,       2560U,
    3072U,     3584U,      4096U,      4608U,      5120U,       5632U,
    6144U,     6656U,      7168U,      7680U,      8192U,       8704U,
    9216U,     9728U,      10240U,     10752U,     12288U,      16384U,
    20480U,    24576U,     28672U,     32768U,     36864U,      40960U,
...
namespace DLSmallHeapNS {
enum { NUMBINS = 8 };
inline int getSizeClass(const size_t sz) { return (int)((sz - 1) >> 3); }
inline size_t getClassSize(const int i) {
  assert(i >= 0);
  assert(i < NUMBINS);
...
template <class super>
class DLBigHeapType
    : public CoalesceHeap<RequireCoalesceable<
          SegHeap<DLBigHeapNS::NUMBINS, DLBigHeapNS::getSizeClass,
                  DLBigHeapNS::getClassSize, AdaptHeap<DLList, NullHeap<super>>,
                  super>>> {};
...
class DLSmallHeapType
    : public RequireCoalesceable<
          StrictSegHeap<DLSmallHeapNS::NUMBINS, DLSmallHeapNS::getSizeClass,
                        ...
                        AdaptHeap<HL::SLList, NullHeap<super>>, super>> {};
