...
template <class Obj, int MAX_ENTRIES = 300000> class Log {
public:
  Log() : numEntries(0) {
#if defined(unix)
...
template <class SuperHeap> class LogHeap : public SuperHeap {
public:
  LogHeap() : allDone(false) {}
...
private:
  ...
  public:
    ...
    int getType() { return _address & 7; }

    int getAllocated() { return _size; }

    int getDeallocated() { return _size; }

    unsigned long getAddress() { return _address & ~7; }
