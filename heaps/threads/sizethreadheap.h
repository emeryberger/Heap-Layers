...
template <class Super> class SizeThreadHeap : public Super {
public:
  ...
  static inline size_t &size(void *ptr) { return getOrigPtr(ptr)->size; }

  static inline int &thread(void *ptr) { return getOrigPtr(ptr)->tid; }
...
private:
  ...
  static inline st *getOrigPtr(void *ptr) { return (st *)((double *)ptr - 1); }
};
}
