...
template <int NumBins, int (*size2class)(const size_t),
          size_t (*class2size)(const int), class LittleHeap, class BigHeap>
class StrictSegHeap
    : public SegHeap<NumBins, size2class, class2size, LittleHeap, BigHeap> {
private:
  typedef SegHeap<NumBins, size2class, class2size, LittleHeap, BigHeap>
      SuperHeap;
