...
template <class Header> class bins<Header, 4096> {

public:
  bins() { static_assert(BIG_OBJECT > 0, "BIG_OBJECT must be positive."); }
...
const size_t HL::bins<Header, 4096>::_bins[NUM_BINS] = {
    8UL,    16UL,   24UL,
    32UL,   40UL,   48UL,
    56UL,   64UL,   72UL,
    80UL,   88UL,   96UL,
    ...
    352UL,  416UL,  496UL,
    592UL,  704UL,  856UL,
    1024UL, 1224UL, 1712UL,
    2048UL, 3416UL, 4096UL - sizeof(Header)};
