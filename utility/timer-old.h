...
static void getTime(unsigned long &tlo, unsigned long &thi) {
  asm volatile("rdtsc" : "=a"(tlo), "=d"(thi));
}
...
class Timer {
public:
  Timer(void) : timeElapsed(0.0) {
    _frequency = getFrequency();
    //    printf ("wooo!\n");
    //  printf ("freq = %lf\n", frequency);
  }
  void start(void) { getTime(currentLo, currentHi); }
  void stop(void) {
    unsigned long lo, hi;
    getTime(lo, hi);
  ...
  operator double(void) { return timeElapsed; }
...
#define TIMER_FOUND
  ...
  static double _timetosec(long t) { return ((double)(t) / CLK_TCK); }

  static long _sectotime(double sec) { return (long)sec * CLK_TCK; }
#endif
...
#define TIMER_FOUND
  ...
  static TimeType _time(void) { return gethrtime(); }

  static TimeType _sectotime(double sec) { return (hrtime_t)(sec * 1.0e9); }

  static double _timetosec(TimeType &t) { return ((double)(t) / 1.0e9); }
#endif // __SVR4
...
#define TIMER_FOUND
  ...
  double _time(void) { return get_Mac_microseconds(); }

  double _timetosec(hrtime_t &t) { return t; }
#endif // MAC
...
#define TIMER_FOUND
  ...
  static double _timetosec(TimeType &t) { return t.timeToSec(); }
#else
  typedef DWORD TimeType;
  DWORD _starttime, _elapsedtime;
  static DWORD _time(void) { return GetTickCount(); }

  static double _timetosec(DWORD &t) { return (double)t / 100000.0; }
  static unsigned long _sectotime(double sec) { return (unsigned long)(sec); }
#endif
#endif // _WIN32
...
#define TIMER_FOUND
  ...
  bigtime_t _time(void) { return system_time(); }
  double _timetosec(bigtime_t &t) { return (double)t / 1000000.0; }

  bigtime_t _sectotime(double sec) { return (bigtime_t)(sec * 1000000.0); }
#endif // __BEOS__
  ...
  static double _timetosec(TimeType t) { return ((double)(t) / 1000000.0); }

  static TimeType _sectotime(double sec) { return (TimeType)(sec * 1000000.0); }
...
public:
  hrtime_t _time(void) { return gethrvtime(); }
};
#endif
}
