...
template <class Header> class bins<Header, 16384> {
public:
  bins() { static_assert(BIG_OBJECT > 0, "Big object must be positive."); }
...
const size_t HL::bins<Header, 16384>::_bins[NUM_BINS] = {
    8,    16,   24,   32,   40,   56,   80,    112,
    160,  224,  320,  456,  648,  920,  1312,  1864,
    2656, 3784, 5392, 5448, 7760, 8176, 11648, 16384 - sizeof(Header)};

template <class Header>
const int HL::bins<Header, 16384>::_sizeclasses[NUM_SIZECLASSES] = {
    0,  1,  2,  3,  4,  5,  5,  6,  6,  6,  7,  7,  7,  7,  8,  8,  8,  8,  8,
    ...
    18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18,
    18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18,
    18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20,
